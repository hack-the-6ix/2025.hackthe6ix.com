  ...
  return (
    <section> 
      ...
      <Flex className={styles.header_text} align='center' justify='center' direction='column'>
            ...
            <Text textType={isMobile ? 'subtitle-lg' : 'display'} textWeight='black'>
        ...
        <Text textType="paragraph-lg" as="p" style={{ padding: '16px' }}>
          ...
          {/* Main */}
              ...
              <Flex direction='column' className={styles.card}>
                ...
                <Card2 borderColor="frameBrown" contentColor="showcase-100" padding={50}>
                <Flex direction='row' gap='x-huge'>

                    {/* Project Pic*/}
                    <Card pixelSize={8} radius={2} borderWidth={1} borderColor='secondary-400'  
                      ...
                      >
                      <Card padding={isMobile ? 25 : 35} backgroundColor='#EBA867'>
                        <Card pixelSize={6} radius={4} borderWidth={1}  borderColor='secondary' padding={-1}>
                ...
                <Flex direction='row' gap='2x-big' justify="space-between">
                  <Flex direction='column' className='pr-15'> 
                    ...
                    <Flex justify='center'>
                      ...
                      <Link href={see_all_proj_link}>
                        ...
                        <Button pixelSize={5} radius={4} borderWidth={1} buttonPadding={13} borderColor='frameBlack' backgroundColor='#6D4A41'>
